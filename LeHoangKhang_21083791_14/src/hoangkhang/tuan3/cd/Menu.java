...
public class Menu {
	...
	public String centerText(String text) { 
		String stringFormat =  String.format("%" 
				+ String.valueOf(width/2 + text.length()/2 + 1) 
				+ "s", text);
	...
	public String notification(String type, String message) {
		...
		if (type.equalsIgnoreCase("error")) result += "**ERROR: ";
		if (type.equalsIgnoreCase("success")) result += "**SUCCESS: ";
		if (type.equalsIgnoreCase("info")) result += "**INFO: ";
		if (type.equalsIgnoreCase("warn")) result += "**WARN: ";
