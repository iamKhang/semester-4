...
import tuan03_24_QuanLySachAbtractTable.Sach;

public class SachDefaultTableModel extends DefaultTableModel {
	 ...
	 * @param dsSach
	 */
	public SachDefaultTableModel(ArrayList<Sach> dsSach) {
		this.dsSach = dsSach;
	} 
